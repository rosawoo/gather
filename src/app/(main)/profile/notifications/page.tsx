  ...
  return (
    <div className="pb-10">
      ...
      <ul className="space-y-3">
        {items.length === 0 ? (
          <li className="rounded-2xl border border-dashed border-gather-teal/35 bg-white/50 px-4 py-8 text-center text-sm text-gather-charcoal/80">
              ...
              <li
                ...
                className={`rounded-2xl border p-4 text-sm shadow-sm transition ${
                  isUnread
                    ...
                    : "border-gather-teal/25 bg-white ring-1 ring-gather-teal/10"
                }`}
              >
                {isUnread && (
                ...
                <p className="mt-1 leading-relaxed text-gather-ink">{n.body}</p>
                <p className="mt-2 text-xs text-gather-charcoal/55">
